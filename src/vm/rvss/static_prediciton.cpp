/**
 * @file stages.cpp
 * @brief RVSS VM pipeline stages implementation (renamed class: Prediction)
...
void Prediction::WriteMemoryFloat() {
  //uint8_t rs2 = (current_instruction_ >> 20) & 0b11111;
...
void Prediction::WriteMemoryDouble() {
  //uint8_t rs2 = (current_instruction_ >> 20) & 0b11111;
...
void Prediction::WriteBackFloat() {
  // uint8_t opcode = current_instruction_ & 0b1111111;
  // uint8_t funct7 = (current_instruction_ >> 25) & 0b1111111;
  // uint8_t rd = (current_instruction_ >> 7) & 0b11111;
...
void Prediction::WriteBackDouble() {
  // uint8_t opcode = current_instruction_ & 0b1111111;
  // uint8_t funct7 = (current_instruction_ >> 25) & 0b1111111;
  // uint8_t rd = (current_instruction_ >> 7) & 0b11111;
